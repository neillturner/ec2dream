EC2Dream Fogviz - Build and Manage Cloud Servers Version 3.6.7 -  Sept 2013 
-----------------------------------------------------------------------------
...
It uses Chef Solo or Masterless Puppet to install software and applications via "one click".
