...
class EC2_InstanceDialog < FXDialogBox
  ...
  def initialize(owner)
    ...
    itemlist.appendItem('m1.small            (Small 32 or 64-bit, 1.7 GB, 1 compute unit)')
    itemlist.appendItem('m1.medium       (Medium 32 or 64-bit, 3.75 GB, 2 compute unit)')
    ...
    itemlist.appendItem('cg1.4xlarge        (Cluster GPU Quadruple Extra Large  64-bit, 22 GB, 33.5 compute unit. 10GBit network)')
